...
public class LeftTopInformationComponent implements UIComponent {
    private static final String SHOW_TEXT = "Show information";
    private static final String HIDE_TEXT = "Hide information";
    private static final int NINE_PATCH_BOARDER = 4;
    ...
    public LeftTopInformationComponent(Texture background, int informationPanelWidth, int informationPanelHeight) {
    ...
    public void prepareComponent(UIElements uiElements) {
        NinePatch backgroundNinePatch = new NinePatch(background, NINE_PATCH_BOARDER, NINE_PATCH_BOARDER,
                NINE_PATCH_BOARDER, NINE_PATCH_BOARDER);
